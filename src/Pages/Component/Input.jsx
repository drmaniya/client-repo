...
return(
	<div  className={`mb-4 ${props.className}`}>
							...
							<input type="text" onChange={props.onChange} className="inputWrapper form-control " placeholder={`${props.placeholder ? props.placeholder:''}`} aria-label="Sizing example input" aria-describedby="inputGroup-sizing-lg"/>
